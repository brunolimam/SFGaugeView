...
open class SFGaugeView: UIView {
   ...
   private func setup() {
    ...
    private func drawBackground() {
        ...
        let redColor = self.redColor ?? SFGaugeColors.red()
        let yellowColor = self.yellowColor ?? SFGaugeColors.yellow()
        let greenColor = self.greenColor ?? SFGaugeColors.green()
    ...
    func drawNeedle() {
        ...
        let needleColor = self.needleColor ?? SFGaugeColors.grey()
        needleColor.set()
        needlePath.fill()
    }
    ...
    func drawLabel(title: NSString, onPoint: CGPoint) {
        ...
        let labelColor = self.labelColor ?? SFGaugeColors.grey700()
